    ...
    const claimProject = async () => {
      try {
        const res = await axios.post(
          `${API_BASE}/api/projectsmanage/${id}/claim`,
    ...
    if (timeLeft === 0 && !isSubmitted && project) {
      const handleTimeout = async () => {
        ...
        const timeoutLog = {
          ...
          actor: "SYSTEM",
          message:
            "Lyricist process timed-out. Project placed back into the Lyricist queue.",
        };
  ...
  if (project) {
    return (
      <main className="max-w-4xl mx-auto p-6 font-montserrat">
        ...
        <div className="mb-4 text-center">
          ...
          <div
            className={`font-bold text-lg ${
              timeLeft <= 0.2 * config.projectMinLimit * 60
                ? "text-red-700"
                : "text-green-700"
            }`}
          >
        ...
        {/* Song Details */}
        <div className="bg-sand-100 shadow-inner rounded p-6 mb-6">
        ...
        {/* Logs */}
        <div className="bg-sand-100 shadow p-4 mb-6">
        ...
        {/* Lyrics Workspace */}
        <div className="bg-sand-100 shadow p-4">
          ...
          {showTimeoutModal && (
            ...
            >
              ...
              <p>
                ...
                This project has been placed back into the Lyricist queue.
              </p>
    ...
    return (
      <div>
        ...
        >
          <h2>Sorry</h2>
          <p>
            Project not found or project is currently not available for Lyricist
            operation.
          </p>
          <div className="flex justify-center">
            <button
