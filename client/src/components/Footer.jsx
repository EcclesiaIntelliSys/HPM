...
export default function Footer() {
  return (
    <footer className="mt-8 bg-olive-50 border-t border-sand-200">
      <div className="max-w-6xl mx-auto p-6 flex flex-col md:flex-row items-center justify-between">
        <div className="text-sand-800 text-xs">© {new Date().getFullYear()} Heart Prayer Music</div>
        <div className="flex space-x-4 mt-4 md:mt-0 items-center">
{/* YouTube */}
<a href="https://www.youtube.com/your-channel" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
  <svg className="w-9 h-9 text-red-600 hover:text-red-700" viewBox="0 0 24 24" fill="none" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
...
<a href="https://www.facebook.com/your-page" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
  <svg className="w-8 h-8 text-blue-600 hover:text-blue-700" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
...
<a href="https://www.instagram.com/your-profile" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
  <svg className="w-8 h-8 hover:opacity-90" viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
    <defs>
...
<a href="https://x.com/yourprofile" target="_blank" rel="noopener noreferrer" aria-label="X">
  <svg className="w-8 h-8 text-slate-900 hover:text-sky-500" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
